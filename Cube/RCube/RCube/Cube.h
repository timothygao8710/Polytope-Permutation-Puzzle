...
inline void Cube::Move(const byte face, const  int depth, const int q)
{
    ...
    // codicon added
    std::vector<std::string> invert_str = {"", "-"};
    bool invert = 0;
    int rotations = (q+4) % 4;
	...
	case 0: //F
        ...
        for (int i = 0; i < rotations; i++) {
            solution += "." + invert_str[invert] + "f" + std::to_string(depth);
        }
	...
	case 1: //R
        // codicon added
        for (int i = 0; i < rotations; i++) {
            solution += "." + invert_str[invert] + "r" + std::to_string(depth);
        }
	...
	case 2: //B
        // codicon added
        for (int i = 0; i < rotations; i++) {
            solution += "." + invert_str[invert^1] + "f" + std::to_string(R1 - depth);
        }
	...
	case 3: //L
        // codicon added
        for (int i = 0; i < rotations; i++) {
            solution += "." + invert_str[invert^1] + "r" + std::to_string(R1 - depth);
        }
	...
	case 4: //U
        // codicon added
        for (int i = 0; i < rotations; i++) {
            solution += "." + invert_str[invert^1] + "d" + std::to_string(R1 - depth);
        }
	...
	case 5: //D
        // codicon added
        for (int i = 0; i < rotations; i++) {
            solution += "." + invert_str[invert] + "d" + std::to_string(depth);
        }
